...
public class frmInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        munConfiguraciones = new javax.swing.JMenu();
        munUsuariosAccesos = new javax.swing.JMenuItem();
        munHeramientas = new javax.swing.JMenu();
        munAyuda = new javax.swing.JMenu();
        ...
        mnuConsultas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/consulta.png"))); // NOI18N
        mnuConsultas.setText("Consultas");
        mnuConsultas.setFont(new java.awt.Font("SimHei", 0, 15)); // NOI18N
        menuBar.add(mnuConsultas);

        munConfiguraciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/configuraciones.png"))); // NOI18N
        munConfiguraciones.setText("Configuraciones");
        munConfiguraciones.setFont(new java.awt.Font("SimHei", 0, 15)); // NOI18N
        ...
        munConfiguraciones.add(munUsuariosAccesos);

        menuBar.add(munConfiguraciones);

        munHeramientas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/computadora.png"))); // NOI18N
        munHeramientas.setText("Herramientas");
        munHeramientas.setFont(new java.awt.Font("SimHei", 0, 15)); // NOI18N
        menuBar.add(munHeramientas);

        munAyuda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ayuda.png"))); // NOI18N
        munAyuda.setText("Ayuda");
        munAyuda.setFont(new java.awt.Font("SimHei", 0, 15)); // NOI18N

        jMenuItem3.setFont(new java.awt.Font("Segoe UI Black", 0, 15)); // NOI18N
        jMenuItem3.setText("Acerca de ...");
        munAyuda.add(jMenuItem3);

        jMenuItem4.setFont(new java.awt.Font("Segoe UI Black", 0, 15)); // NOI18N
        jMenuItem4.setText("Ayuda");
        munAyuda.add(jMenuItem4);

        menuBar.add(munAyuda);
    ...
    private javax.swing.JMenu munAyuda;
    private javax.swing.JMenuItem munClientes;
    public static javax.swing.JMenu munConfiguraciones;
    private javax.swing.JMenuItem munHabitaciones;
    private javax.swing.JMenu munHeramientas;
